...
function CopyButton({ text, label }: { text: string; label: string }) {
  ...
  return (
    ...
    >
      {copied ? (
        <>
          <svg aria-hidden="true" className="w-3 h-3 text-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="space-y-6" id="analysis-content" aria-live="polite">
      ...
      {analysis.participants && analysis.participants.length > 0 && (
        <div>
          <h3 className="font-semibold text-ink mb-3 flex items-center gap-2">
            <svg aria-hidden="true" className="w-5 h-5 text-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {analysis.contract_timeline && analysis.contract_timeline.length > 0 && (
        <div>
          <h3 className="font-semibold text-slate-900 mb-3 flex items-center gap-2">
            <svg aria-hidden="true" className="w-5 h-5 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {analysis.legal_references && analysis.legal_references.length > 0 && (
        <div>
          <h3 className="font-semibold text-slate-900 mb-3 flex items-center gap-2">
            <svg aria-hidden="true" className="w-5 h-5 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
